...
const ProjectCard = ({title, progress, range, targetScale, image, i}: Props) => {
  ...
  return (
    <div className="w-full h-[70vh]  flex flex-col items-center justify-center sticky top-0">
      
    <motion.div style={ {willChange: "transform", y: `calc(-5% + ${i * 25}px)`, scale}} className={`w-full lg:w-9/12 h-5/12 lg:h-10/12 flex flex-col items-center justify-center text-white  relative  scale-[${i}] bg-accent overflow-hidden`}>
