...
const ProjectCard = ({title, assetLink, progress, range, targetScale, image, i, id}: Props) => {
  ...
  return (
    ...
    <motion.div className={`w-full h-5/12 flex flex-col items-center justify-center text-white  relative gap-3 bg-primary rounded-lg pb-3 border border-primary/50`}>
