...
export default function TestimonialCard({ name, role, image, quote}: TestimonialType) {
  return (
    <div className="shrink-0 flex gap-2 items-start rounded bg-foreground p-2 text-primary">
      <div className="min-w-15 h-15 rounded-full overflow-hidden">
        <Image width={80} height={80}  className="rounded-full object-cover h-full w-full" src={image} alt="client testimonial image" />
      </div>
