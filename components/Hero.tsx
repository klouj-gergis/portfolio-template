...
export default function Hero() {
  return (
    <section className="h-screen   w-full flex flex-col md:flex-row relative justify-end border-b border-text-secondary/5">
      <div className=" h-7/12 lg:h-full bg-background flex flex-col justify-start items-start gap-4 p-8 pt-0 md:w-1/2 md:justify-center xl:pl-20">
