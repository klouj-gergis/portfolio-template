...
export default function Hero() {
  return (
    <section className="h-[90vh] lg:h-screen   w-full flex flex-col md:flex-row justify-end border-b border-secondary-text relative bg-gradient-to-r from-slate-500 to-slate-800">
      ...
      <div className=" h-8/12 lg:h-full bg-background  flex flex-col justify-center items-start gap-4 p-8 md:w-1/2 md:justify-center xl:pl-20">
          <h1 className="text-5xl font-bold md:text-9xl  text-text-main font-heading border pt-2 px-4 border-white/30 rounded-lg bg-white/5 backdrop-blur-[1px]">
          MAGOMY
        </h1>
