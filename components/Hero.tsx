...
export default function Hero() {
  return (
    <section className="h-screen w-full flex flex-col md:flex-row relative justify-end">
      <div className=" h-full flex flex-col justify-end items-start gap-4 p-8 pb-30 md:w-1/2 md:justify-center xl:pl-20">
        ...
        <div className="fixed md:relative top-0 left-0 w-full h-2/6 md:full overflow-hidden z-10 md:z-0 md:h-full md:w-1/2">
          <Image src="/hero.jpg" alt="Hero Image" width={600} height={400} className="absolute -top-2/6 md:-top-1/6 w-full" />
        </div>
    </section>
  )
}
